/* ----------------------------------------------------------------------------
 * ergoDOX layout : Colemak-Tarmak-Level 1
 * ----------------------------------------------------------------------------
 * This layout created by Persa Zula <persa@persazula.com>
 * Released under The MIT License (MIT) (see "license.md")
 * Project located at <https://github.com/pzula/ergodox-firmware>
 * ------------------------------------------------------------------------- */
...
// right hand
     ...
     _esc, _Y,      _U,      _I,      _O,         _P, _bracketR,
           _H,      _N,      _E,      _L, _semicolon,    _quote,
